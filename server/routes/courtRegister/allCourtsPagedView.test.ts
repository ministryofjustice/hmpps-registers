...
describe('AllCourtsPagedView', () => {
  ...
  describe('with many courts', () => {
    ...
    it('will map page controls', () => {
      expect(view.courtsPageView.first).toEqual(true)
      expect(view.courtsPageView.last).toEqual(true)
      expect(view.courtsPageView.empty).toEqual(false)
      expect(view.courtsPageView.totalPages).toEqual(1)
      expect(view.courtsPageView.totalElements).toEqual(3)
      expect(view.courtsPageView.pageNumber).toEqual(0)
      expect(view.courtsPageView.pageSize).toEqual(20)
      expect(view.courtsPageView.elementsOnPage).toEqual(3)
    })
  })
})
