...
context('Court register - court list navigation', () => {
  ...
  it('Will change the active filter', () => {
    ...
    page.showFilterButton().click()
    page.activeAllFilter().should('have.attr', 'type', 'radio').should('be.checked')
    page.activeOpenFilter().should('have.attr', 'type', 'radio').should('not.be.checked')
    page.activeClosedFilter().should('have.attr', 'type', 'radio').should('not.be.checked')
    page.activeOpenFilter().click()
    page.applyFilterButton().click()
    page.showFilterButton().click()
    page.activeAllFilter().should('not.be.checked')
    page.activeOpenFilter().should('be.checked')
